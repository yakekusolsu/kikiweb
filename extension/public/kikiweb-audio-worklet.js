  ...
  process(_inputs, outputs) {
    ...
    for (let index = 0; index < left.length; index += 1) {
      ...
      if (!this.needsResampling) {
        ...
        left[index] = (buffer[readIndex] / 32768) * this.volume;
        right[index] = (buffer[readIndex + 1] / 32768) * this.volume;
      ...
      left[index] = (leftSample / 32768) * this.volume;
      right[index] = (rightSample / 32768) * this.volume;
